...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 20:01:59 2021
...
def AddData(myWindow,myEntryName,myEntryID,myEntryPass):  
    ...
    info=[myEntryName.get(),myEntryID.get(),myEntryPass.get(),1,0,32767,32767,32767]
    info = tuple(info)
    print(info)
    ...
    if mycon.is_connected==False:
        ...
        myQry="INSERT INTO UserData VALUES(%s,%s,%s,%s,%s,%s,%s,%s)"            
...
def MainGame(myEntryID,myEntryPass,myWindow):
    ...
    if mycon.is_connected==False:
        ...
        myQry = "SELECT * FROM UserData where User_ID = %s and Password = %s"
        myCursor=mycon.cursor()
    ...
    if myCursor.rowcount!= -1:
        ...
        myLabelName.place(x=50,y=100,width=150,height=25)
        
        myLabelHighScore=Label(myWindowGame,text="HighScore: "+str(UserInfo[5]),padx=75,pady=15,font=('times',20)) 
        myLabelHighScore.place(x=400,y=100,width=150,height=25)
        
        myLabelHighScore=Label(myWindowGame,text="Curent Score: "+str(UserInfo[4]),padx=75,pady=15,font=('times',20)) 
        myLabelHighScore.place(x=225,y=100,width=150,height=25)
               
        myButtonlvl1 = Button(myWindowGame,text="LEVEL I",padx=75,pady=15,font=('times',30),command = Level_I) 
        myButtonlvl1.place(x=200,y=150,width=200,height=100)
        
        myButtonlvl2 = Button(myWindowGame,text="LEVEL II",padx=75,pady=15,font=('times',30),command = Level_II) 
        myButtonlvl2.place(x=200,y=300,width=200,height=100)

        myButtonlvl3 = Button(myWindowGame,text="LEVEL III",padx=75,pady=15,font=('times',30),command = Level_III) 
        myButtonlvl3.place(x=200,y=450,width=200,height=100)
...
myEntryPass = Entry(myWindow,width=35,show="*") #User ID Input
